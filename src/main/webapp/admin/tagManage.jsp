...
<script type="text/javascript">
	...
	function openTagAddDialog(){
		...
		url="${pageContext.request.contextPath}/admin/tag/saveTag.do";
	}
	...
	function openTagModifyDialog(){
		...
		$("#fm").form("load",row);
		//alert(row.content);
		url="${pageContext.request.contextPath}/admin/tag/saveTag.do?id="+row.id;
	}
	...
	function deleteTag(){
		...
		$.messager.confirm("系统提示","您确认要删掉这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("${pageContext.request.contextPath}/admin/tag/delTag.do",{ids:ids},function(result){
					if(result.success){
...
<table id="dg" title="标签管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/admin/tag/list.do" fit="true"
 toolbar="#tb">
    <thead>
    	<tr>
    		<th field="cb" checkbox="true" align="center"></th>
    		<th field="id" width="50" align="center">编号</th>
    		<th field="name" width="50" align="center">标签名字</th>
    	</tr>
    </thead>
</table>
<div id="tb">
	...
	<div>
		&nbsp;标签名字：&nbsp;<input type="text" name="tag.name" value="${s_tag.name }" id="tagName"  size="20" onkeydown="if(event.keyCode==13) searchTag()"/>
